package com.common.widget.pickerview.configure;
...
import com.common.widget.pickerview.listener.CustomListener;
import com.common.widget.pickerview.listener.OnOptionsSelectChangeListener;
import com.common.widget.pickerview.listener.OnOptionsSelectListener;
import com.common.widget.pickerview.listener.OnTimeSelectChangeListener;
import com.common.widget.pickerview.listener.OnTimeSelectListener;
...
public class PickerOptions {
    ...
    public PickerOptions(int buildType) {
        if (buildType == TYPE_PICKER_OPTIONS) {
            layoutRes = R.layout.common_pickerview_options;
        } else {
            layoutRes = R.layout.common_pickerview_time;
        }
    }
