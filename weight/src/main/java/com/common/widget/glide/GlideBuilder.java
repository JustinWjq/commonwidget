...
import com.common.widget.glide.load.engine.executor.FifoPriorityThreadPoolExecutor;
import com.common.widget.glide.load.engine.Engine;
import com.common.widget.glide.load.engine.bitmaprecycle.BitmapPoolAdapter;
import com.common.widget.glide.load.engine.bitmaprecycle.LruBitmapPool;
import com.common.widget.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import com.common.widget.glide.load.engine.cache.LruResourceCache;
import com.common.widget.glide.load.engine.cache.MemorySizeCalculator;
...
public class GlideBuilder {
     ...
     * @return This builder.
     */
    public com.common.widget.glide.GlideBuilder setMemoryCache(MemoryCache memoryCache) {
     ...
     * @return This builder.
     */
    public com.common.widget.glide.GlideBuilder setDiskCache(DiskCache.Factory diskCacheFactory) {
     ...
     * @return This builder.
     */
    public com.common.widget.glide.GlideBuilder setResizeService(ExecutorService service) {
     ...
     * @return This builder.
     */
    public com.common.widget.glide.GlideBuilder setDiskCacheService(ExecutorService service) {
     ...
     * @return This builder.
     */
    public com.common.widget.glide.GlideBuilder setDecodeFormat(DecodeFormat decodeFormat) {
        this.decodeFormat = decodeFormat;
        return this;
    }

    // For testing.
    com.common.widget.glide.GlideBuilder setEngine(Engine engine) {
        this.engine = engine;
        return this;
    }
