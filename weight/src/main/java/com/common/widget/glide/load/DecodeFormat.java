package com.common.widget.glide.load;

import com.common.widget.glide.load.resource.bitmap.BitmapDecoder;

/**
 * Options for setting the value of {@link android.graphics.Bitmap#getConfig()} for {@link android.graphics.Bitmap}s
 * returned by a {@link BitmapDecoder}.
 *
 * <p>
 *     Note - In some cases it may not be possible to obey the requested setting, not all
 *     {@link BitmapDecoder}s support setting formats and certain images may
