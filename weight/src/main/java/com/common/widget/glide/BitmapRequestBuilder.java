...
import com.common.widget.glide.load.resource.bitmap.Downsampler;
import com.common.widget.glide.load.resource.bitmap.FitCenter;
import com.common.widget.glide.request.animation.BitmapContainerCrossFadeFactory;
...
import com.common.widget.glide.load.resource.bitmap.FileDescriptorBitmapDecoder;
import com.common.widget.glide.load.resource.bitmap.ImageVideoBitmapDecoder;
import com.common.widget.glide.load.resource.bitmap.StreamBitmapDecoder;
import com.common.widget.glide.load.resource.bitmap.VideoBitmapDecoder;
...
import com.common.widget.glide.request.animation.BitmapCrossFadeFactory;
...
public class BitmapRequestBuilder<ModelType, TranscodeType>
     ...
     */
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> approximate() {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> asIs() {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> atMost() {
     ...
     * @return This request builder.
     */
    private com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> downsample(Downsampler downsampler) {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> thumbnail(float sizeMultiplier) {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> thumbnail(com.common.widget.glide.BitmapRequestBuilder<?, TranscodeType>
            thumbnailRequest) {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> sizeMultiplier(float sizeMultiplier) {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> decoder(ResourceDecoder<ImageVideoWrapper, Bitmap> decoder) {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> cacheDecoder(ResourceDecoder<File, Bitmap> cacheDecoder) {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> encoder(ResourceEncoder<Bitmap> encoder) {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> imageDecoder(ResourceDecoder<InputStream, Bitmap> decoder) {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> videoDecoder(
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> format(DecodeFormat format) {
    ...
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> priority(Priority priority) {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> transform(BitmapTransformation... transformations) {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> centerCrop() {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> fitCenter() {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> transform(Transformation<Bitmap>... transformations) {
        super.transform(transformations);
        return this;
    }
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> transcoder(
    ...
    public final com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> crossFade() {
     ...
     */
    @SuppressWarnings("unchecked")
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> crossFade(int duration) {
        if (Bitmap.class.isAssignableFrom(transcodeClass)) {
            return animate((GlideAnimationFactory<TranscodeType>)
    ...
    @Deprecated
    @SuppressWarnings("unchecked")
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> crossFade(Animation animation, int duration) {
        if (Bitmap.class.isAssignableFrom(transcodeClass)) {
            return animate((GlideAnimationFactory<TranscodeType>)
     ...
     */
    @SuppressWarnings("unchecked")
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> crossFade(int animationId, int duration) {
        if (Bitmap.class.isAssignableFrom(transcodeClass)) {
            return animate((GlideAnimationFactory<TranscodeType>)
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> dontAnimate() {
        super.dontAnimate();
        return this;
    }
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> animate(int animationId) {
    ...
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> animate(Animation animation) {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> animate(ViewPropertyAnimation.Animator animator) {
    ...
    /**
     * {@inheritDoc}
     * @see BitmapContainerCrossFadeFactory
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> animate(
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> placeholder(int resourceId) {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> placeholder(Drawable drawable) {
        super.placeholder(drawable);
        return this;
    }

    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> fallback(Drawable drawable) {
        super.fallback(drawable);
        return this;
    }

    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> fallback(int resourceId) {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> error(int resourceId) {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> error(Drawable drawable) {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> listener(
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> skipMemoryCache(boolean skip) {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> diskCacheStrategy(DiskCacheStrategy strategy) {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> override(int width, int height) {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> thumbnail(
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> sourceEncoder(Encoder<ImageVideoWrapper> sourceEncoder) {
     ...
     */
    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> dontTransform() {
        super.dontTransform();
        return this;
    }

    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> signature(Key signature) {
        super.signature(signature);
        return this;
    }

    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> load(ModelType model) {
        super.load(model);
        return this;
    }

    @Override
    public com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType> clone() {
        return (com.common.widget.glide.BitmapRequestBuilder<ModelType, TranscodeType>) super.clone();
    }
