package com.common.widget.glide.util;
...
public class ExceptionCatchingInputStream extends InputStream {
    ...
    public static com.common.widget.glide.util.ExceptionCatchingInputStream obtain(InputStream toWrap) {
        com.common.widget.glide.util.ExceptionCatchingInputStream result;
        synchronized (QUEUE) {
            result = QUEUE.poll();
        }
        if (result == null) {
            result = new com.common.widget.glide.util.ExceptionCatchingInputStream();
        }
