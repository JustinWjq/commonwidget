...
import com.common.widget.glide.load.data.StreamAssetPathFetcher;
import com.common.widget.glide.load.data.StreamLocalUriFetcher;
...
public class StreamUriLoader extends UriLoader<InputStream> implements StreamModelLoader<Uri> {
    ...
    public static class Factory implements ModelLoaderFactory<Uri, InputStream> {
        ...
        public ModelLoader<Uri, InputStream> build(Context context, GenericLoaderFactory factories) {
            return new com.common.widget.glide.load.model.stream.StreamUriLoader(context, factories.buildModelLoader(GlideUrl.class, InputStream.class));
        }
