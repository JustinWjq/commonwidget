...
public final class ByteArrayPool {
    ...
    private static final com.common.widget.glide.util.ByteArrayPool BYTE_ARRAY_POOL = new com.common.widget.glide.util.ByteArrayPool();

    /**
     * Returns a constant singleton byte array pool.
     */
    public static com.common.widget.glide.util.ByteArrayPool get() {
