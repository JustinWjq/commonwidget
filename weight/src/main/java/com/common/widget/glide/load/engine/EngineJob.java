...
import com.common.widget.glide.request.ResourceCallback;
...
class EngineJob implements EngineRunnable.EngineRunnableManager {
    ...
    private final com.common.widget.glide.load.engine.EngineJobListener listener;
    ...
    private com.common.widget.glide.load.engine.EngineRunnable engineRunnable;
    private com.common.widget.glide.load.engine.EngineResource<?> engineResource;

    private volatile Future<?> future;

    public EngineJob(Key key, ExecutorService diskCacheService, ExecutorService sourceService, boolean isCacheable,
                     com.common.widget.glide.load.engine.EngineJobListener listener) {
        this(key, diskCacheService, sourceService, isCacheable, listener, DEFAULT_FACTORY);
    }

    public EngineJob(Key key, ExecutorService diskCacheService, ExecutorService sourceService, boolean isCacheable,
                     com.common.widget.glide.load.engine.EngineJobListener listener, EngineResourceFactory engineResourceFactory) {
        this.key = key;
    ...
    public void start(com.common.widget.glide.load.engine.EngineRunnable engineRunnable) {
        this.engineRunnable = engineRunnable;
        future = diskCacheService.submit(engineRunnable);
    }

    @Override
    public void submitForSource(com.common.widget.glide.load.engine.EngineRunnable runnable) {
    ...
    static class EngineResourceFactory {
        public <R> com.common.widget.glide.load.engine.EngineResource<R> build(Resource<R> resource, boolean isMemoryCacheable) {
            return new com.common.widget.glide.load.engine.EngineResource<R>(resource, isMemoryCacheable);
        }
    }
    ...
    private static class MainThreadCallback implements Handler.Callback {
        ...
        public boolean handleMessage(Message message) {
            if (MSG_COMPLETE == message.what || MSG_EXCEPTION == message.what) {
                com.common.widget.glide.load.engine.EngineJob job = (com.common.widget.glide.load.engine.EngineJob) message.obj;
