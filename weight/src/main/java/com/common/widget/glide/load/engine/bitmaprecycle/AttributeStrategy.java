...
class AttributeStrategy implements LruPoolStrategy {
    ...
    private final com.common.widget.glide.load.engine.bitmaprecycle.GroupedLinkedMap<Key, Bitmap> groupedMap = new com.common.widget.glide.load.engine.bitmaprecycle.GroupedLinkedMap<Key, Bitmap>();
    ...
    // Visible for testing.
    static class KeyPool extends com.common.widget.glide.load.engine.bitmaprecycle.BaseKeyPool<Key> {
    ...
    // Visible for testing.
    static class Key implements com.common.widget.glide.load.engine.bitmaprecycle.Poolable {
