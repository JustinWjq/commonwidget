package com.common.widget.glide.request.animation;
 ...
 * {@link Target}s in across resource types. Targets that wrap views will be able to
...
public interface GlideAnimation<R> {
     ...
     * @param adapter The {@link GlideAnimation.ViewAdapter} wrapping a view that
     *                can at least return an {@link View} from
     *                {@link GlideAnimation.ViewAdapter#getView()}.
