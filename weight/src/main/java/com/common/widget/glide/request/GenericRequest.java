package com.common.widget.glide.request;
...
import com.common.widget.glide.Priority;
...
import com.common.widget.glide.util.LogTime;
...
public final class GenericRequest<A, T, Z, R> implements Request, SizeReadyCallback,
    ...
    public static <A, T, Z, R> com.common.widget.glide.request.GenericRequest<A, T, Z, R> obtain(
        ...
        com.common.widget.glide.request.GenericRequest<A, T, Z, R> request = (com.common.widget.glide.request.GenericRequest<A, T, Z, R>) REQUEST_POOL.poll();
        if (request == null) {
            request = new com.common.widget.glide.request.GenericRequest<A, T, Z, R>();
        }
