...
import com.common.widget.glide.load.engine.executor.Prioritized;
...
class EngineRunnable implements Runnable, Prioritized {
    ...
    private final com.common.widget.glide.load.engine.DecodeJob<?, ?, ?> decodeJob;

    private Stage stage;

    private volatile boolean isCancelled;

    public EngineRunnable(EngineRunnableManager manager, com.common.widget.glide.load.engine.DecodeJob<?, ?, ?> decodeJob, Priority priority) {
    ...
    interface EngineRunnableManager extends ResourceCallback {
        void submitForSource(com.common.widget.glide.load.engine.EngineRunnable runnable);
    }
}
