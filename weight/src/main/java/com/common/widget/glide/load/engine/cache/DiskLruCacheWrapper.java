...
import com.common.widget.glide.load.engine.cache.disklrucache.DiskLruCache;
...
public class DiskLruCacheWrapper implements DiskCache {
    ...
    private static com.common.widget.glide.load.engine.cache.DiskLruCacheWrapper wrapper = null;

    private final com.common.widget.glide.load.engine.cache.DiskCacheWriteLocker writeLocker = new com.common.widget.glide.load.engine.cache.DiskCacheWriteLocker();
    ...
    public static synchronized DiskCache get(File directory, int maxSize) {
        ...
        if (wrapper == null) {
            wrapper = new com.common.widget.glide.load.engine.cache.DiskLruCacheWrapper(directory, maxSize);
        }
        return wrapper;
    }
