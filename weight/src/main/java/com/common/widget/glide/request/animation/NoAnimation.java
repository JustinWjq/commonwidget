...
public class NoAnimation<R> implements GlideAnimation<R> {
    private static final com.common.widget.glide.request.animation.NoAnimation<?> NO_ANIMATION = new com.common.widget.glide.request.animation.NoAnimation<Object>();
