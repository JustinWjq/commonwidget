...
import static com.common.widget.glide.load.resource.gif.GifDecoder.STATUS_FORMAT_ERROR;


/**
 * A class responsible for creating {@link com.common.widget.glide.gifdecoder.GifHeader}s from data representing animated
 * gifs.
 */
