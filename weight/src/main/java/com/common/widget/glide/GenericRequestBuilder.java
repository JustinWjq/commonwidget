...
import com.common.widget.glide.load.resource.transcode.UnitTranscoder;
...
import com.common.widget.glide.request.target.SizeReadyCallback;
import com.common.widget.glide.request.target.Target;
import com.common.widget.glide.signature.StringSignature;
import com.common.widget.glide.load.MultiTransformation;
import com.common.widget.glide.load.ResourceEncoder;
import com.common.widget.glide.load.resource.UnitTransformation;
import com.common.widget.glide.manager.Lifecycle;
import com.common.widget.glide.manager.RequestTracker;
import com.common.widget.glide.provider.ChildLoadProvider;
import com.common.widget.glide.provider.LoadProvider;
import com.common.widget.glide.request.GenericRequest;
import com.common.widget.glide.request.Request;
import com.common.widget.glide.request.RequestCoordinator;
import com.common.widget.glide.request.RequestFutureTarget;
import com.common.widget.glide.request.RequestListener;
import com.common.widget.glide.request.ThumbnailRequestCoordinator;
import com.common.widget.glide.request.animation.GlideAnimationFactory;
import com.common.widget.glide.request.animation.NoAnimation;
import com.common.widget.glide.request.animation.ViewAnimationFactory;
import com.common.widget.glide.request.animation.ViewPropertyAnimationFactory;
import com.common.widget.glide.request.target.PreloadTarget;
import com.common.widget.glide.signature.EmptySignature;
...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
    ...
    private com.common.widget.glide.GenericRequestBuilder<?, ?, ?, TranscodeType> thumbnailRequestBuilder;
    ...
    GenericRequestBuilder(LoadProvider<ModelType, DataType, ResourceType, TranscodeType> loadProvider,
                          Class<TranscodeType> transcodeClass, com.common.widget.glide.GenericRequestBuilder<ModelType, ?, ?, ?> other) {
     ...
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> thumbnail(
            com.common.widget.glide.GenericRequestBuilder<?, ?, ?, TranscodeType> thumbnailRequest) {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> sizeMultiplier(
            float sizeMultiplier) {
        if (sizeMultiplier < 0f || sizeMultiplier > 1f) {
            throw new IllegalArgumentException("sizeMultiplier must be between 0 and 1");
        }
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> decoder(
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> cacheDecoder(
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> sourceEncoder(
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> diskCacheStrategy(
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> encoder(
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> priority(
            Priority priority) {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> transform(
    ...
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> dontTransform() {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> transcoder(
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> dontAnimate() {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> animate(int animationId) {
     ...
     */
    @Deprecated
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> animate(Animation animation) {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> animate(
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> placeholder(
            int resourceId) {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> fallback(
            Drawable drawable) {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> error(
            int resourceId) {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> listener(
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> skipMemoryCache(boolean skip) {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> override(int width, int height) {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> signature(Key signature) {
        if (signature == null) {
     ...
     * @return This request builder.
     */
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> load(ModelType model) {
        this.model = model;
        isModelSet = true;
        return this;
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> clone() {
        try {
            com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> clone =
                    (com.common.widget.glide.GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType>) super.clone();
