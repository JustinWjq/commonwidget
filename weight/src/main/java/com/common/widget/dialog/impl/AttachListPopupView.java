...
public class AttachListPopupView extends AttachPopupView {
    ...
    protected int getImplLayoutId() {
        return bindLayoutId == 0 ? R.layout.tx_xpopup_attach_impl_list : bindLayoutId;
    }
...
//        recyclerView.setAdapter(adapter);
    ...
    protected void applyDarkTheme() {
        ...
        recyclerView.setBackgroundColor(getResources().getColor(R.color.tx_xpopup_dark_color));
    }
