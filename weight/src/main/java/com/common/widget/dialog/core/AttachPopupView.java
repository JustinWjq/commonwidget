...
import com.common.widget.dialog.widget.PartShadowContainer;
...
public abstract class AttachPopupView extends BasePopupView {
    ...
    protected int getPopupLayoutId() {
        return R.layout.tx_xpopup_attach_popup_view;
    }
        ...
        if (!popupInfo.hasShadowBg) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                if(getPopupImplView().getBackground()==null){
                    ...
                    attachPopupContainer.setBackgroundResource(R.drawable.tx_xpopup_shadow);
                }else {
                    attachPopupContainer.setBackgroundDrawable(getPopupBackground());
                }
            }
