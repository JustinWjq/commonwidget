...
import com.common.widget.dialog.util.FuckRomUtils;
...
public class FullScreenDialog extends Dialog {
    public FullScreenDialog(@NonNull Context context) {
        super(context, R.style.common_XPopup_TransparentDialog);
    }
    ...
    private int getNavigationBarColor(){
        return contentView.popupInfo.navigationBarColor==0 ? TxPopup.getNavigationBarColor()
