...
import com.common.widget.dialog.interfaces.OnCancelListener;
...
public class ConfirmPopupView extends CenterPopupView implements View.OnClickListener {
    ...
    protected int getImplLayoutId() {
        return bindLayoutId != 0 ? bindLayoutId : R.layout.common_xpopup_center_impl_confirm;
    }
    ...
    protected void applyLightTheme() {
        ...
        tv_title.setTextColor(getResources().getColor(R.color.common_xpopup_content_color));
        tv_content.setTextColor(getResources().getColor(R.color.common_xpopup_content_color));
        tv_cancel.setTextColor(Color.parseColor("#666666"));
        tv_confirm.setTextColor(TxPopup.getPrimaryColor());
        if(divider1!=null)divider1.setBackgroundColor(getResources().getColor(R.color.common_xpopup_list_divider));
        if(divider2!=null)divider2.setBackgroundColor(getResources().getColor(R.color.common_xpopup_list_divider));
    }
    ...
    protected void applyDarkTheme() {
        ...
        tv_title.setTextColor(getResources().getColor(R.color.common_xpopup_white_color));
        tv_content.setTextColor(getResources().getColor(R.color.common_xpopup_white_color));
        tv_cancel.setTextColor(getResources().getColor(R.color.common_xpopup_white_color));
        tv_confirm.setTextColor(getResources().getColor(R.color.common_xpopup_white_color));
        if(divider1!=null)divider1.setBackgroundColor(getResources().getColor(R.color.common_xpopup_list_dark_divider));
        if(divider2!=null)divider2.setBackgroundColor(getResources().getColor(R.color.common_xpopup_list_dark_divider));
    }
