...
public class ConfirmPopupView extends CenterPopupView implements View.OnClickListener {
    ...
    protected int getImplLayoutId() {
        return bindLayoutId != 0 ? bindLayoutId : R.layout.tx_xpopup_center_impl_confirm;
    }
...
//        tv_cancel.setTextColor(XPopup.getPrimaryColor());
    ...
    protected void applyDarkTheme() {
        ...
        tv_title.setTextColor(getResources().getColor(R.color.tx_xpopup_white_color));
        tv_content.setTextColor(getResources().getColor(R.color.tx_xpopup_white_color));
        tv_cancel.setTextColor(getResources().getColor(R.color.tx_xpopup_white_color));
        tv_confirm.setTextColor(getResources().getColor(R.color.tx_xpopup_white_color));
        findViewById(R.id.xpopup_divider).setBackgroundColor(getResources().getColor(R.color.tx_xpopup_dark_color));
        findViewById(R.id.xpopup_divider_h).setBackgroundColor(getResources().getColor(R.color.tx_xpopup_dark_color));
        ((ViewGroup)tv_title.getParent()).setBackgroundResource(R.drawable.tx_xpopup_round3_dark_bg);
    }
