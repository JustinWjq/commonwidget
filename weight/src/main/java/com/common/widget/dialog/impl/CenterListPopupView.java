...
import com.common.widget.dialog.widget.VerticalRecyclerView;
...
public class CenterListPopupView extends CenterPopupView {
    ...
    protected int getImplLayoutId() {
        return bindLayoutId == 0 ? R.layout.tx_xpopup_center_impl_list : bindLayoutId;
    }
...
//        recyclerView.setAdapter(adapter);
    ...
    protected void applyDarkTheme() {
        ...
        findViewById(R.id.xpopup_divider).setBackgroundColor(getResources().getColor(R.color.tx_xpopup_list_dark_divider));
    }
    CharSequence title;
    String[] data;
    int[] iconIds;
