...
public class InputConfirmPopupView extends ConfirmPopupView implements View.OnClickListener {
    ...
    protected void onCreate() {
        ...
        XPopupUtils.setCursorDrawableColor(et_input, TxPopup.getPrimaryColor());
        et_input.post(new Runnable() {
            ...
            public void run() {
                ...
                BitmapDrawable focusDrawable = XPopupUtils.createBitmapDrawable(getResources(), et_input.getMeasuredWidth(), TxPopup.getPrimaryColor());
