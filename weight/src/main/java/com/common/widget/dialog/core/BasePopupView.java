...
import com.common.widget.dialog.animator.BlurAnimator;
import com.common.widget.dialog.animator.EmptyAnimator;
...
import com.common.widget.dialog.animator.ShadowBgAnimator;
import com.common.widget.dialog.animator.TranslateAlphaAnimator;
import com.common.widget.dialog.animator.TranslateAnimator;
import com.common.widget.dialog.enums.PopupStatus;
import com.common.widget.dialog.impl.FullScreenPopupView;
import com.common.widget.dialog.impl.PartShadowPopupView;
import com.common.widget.dialog.util.KeyboardUtils;
import com.common.widget.dialog.util.XPopupUtils;
import java.util.ArrayList;
import java.util.List;
import static com.common.widget.dialog.enums.PopupAnimation.NoAnimation;
...
//                removeOnUnhandledKeyEventListener(backPressListener);
    ...
    public int getAnimationDuration() {
        ...
        return popupInfo.animationDuration >= 0 ? popupInfo.animationDuration : TxPopup.getAnimationDuration() + 1;
    }

    public int getShadowBgColor() {
        return popupInfo != null && popupInfo.shadowBgColor != 0 ? popupInfo.shadowBgColor : TxPopup.getShadowBgColor();
    }

    public int getStatusBarBgColor() {
        return popupInfo != null && popupInfo.statusBarBgColor != 0 ? popupInfo.statusBarBgColor : TxPopup.getStatusBarBgColor();
    }
