...
import com.common.widget.recyclerviewadapterhelper.base.BaseItemDraggableAdapter;
import com.common.widget.recyclerviewadapterhelper.base.TxBaseQuickAdapter;
import com.common.widget.recyclerviewadapterhelper.base.DraggableController;
...
public class ItemDragAndSwipeCallback extends ItemTouchHelper.Callback {
    ...
    private boolean isViewCreateByAdapter(@NonNull RecyclerView.ViewHolder viewHolder) {
        ...
        return type == TxBaseQuickAdapter.HEADER_VIEW || type == TxBaseQuickAdapter.LOADING_VIEW
                || type == TxBaseQuickAdapter.FOOTER_VIEW || type == TxBaseQuickAdapter.EMPTY_VIEW;
    }
}
