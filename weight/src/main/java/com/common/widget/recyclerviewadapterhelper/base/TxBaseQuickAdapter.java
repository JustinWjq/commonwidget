...
import com.common.widget.recyclerviewadapterhelper.base.animation.AlphaInAnimation;
import com.common.widget.recyclerviewadapterhelper.base.animation.BaseAnimation;
import com.common.widget.recyclerviewadapterhelper.base.animation.ScaleInAnimation;
import com.common.widget.recyclerviewadapterhelper.base.animation.SlideInBottomAnimation;
import com.common.widget.recyclerviewadapterhelper.base.animation.SlideInLeftAnimation;
import com.common.widget.recyclerviewadapterhelper.base.animation.SlideInRightAnimation;
import com.common.widget.recyclerviewadapterhelper.base.diff.BaseQuickAdapterListUpdateCallback;
import com.common.widget.recyclerviewadapterhelper.base.diff.BaseQuickDiffCallback;
import com.common.widget.recyclerviewadapterhelper.base.entity.IExpandable;
import com.common.widget.recyclerviewadapterhelper.base.loadmore.LoadMoreView;
import com.common.widget.recyclerviewadapterhelper.base.loadmore.SimpleLoadMoreView;
 ...
 */
public abstract class TxBaseQuickAdapter<T, K extends TxBaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    protected static final String TAG = TxBaseQuickAdapter.class.getSimpleName();
     ...
     */
    public TxBaseQuickAdapter(@LayoutRes int layoutResId, @Nullable List<T> data) {
    ...
    public TxBaseQuickAdapter(@Nullable List<T> data) {
        this(0, data);
    }

    public TxBaseQuickAdapter(@LayoutRes int layoutResId) {
    ...
    public void setNewDiffData(@NonNull DiffUtil.DiffResult diffResult, @NonNull List<T> newData) {
        ...
        diffResult.dispatchUpdatesTo(new BaseQuickAdapterListUpdateCallback(TxBaseQuickAdapter.this));
        mData = newData;
    }
    ...
    public void setOnItemClick(View v, int position) {
        getOnItemClickListener().onItemClick(TxBaseQuickAdapter.this, v, position);
    }
    ...
    public boolean setOnItemLongClick(View v, int position) {
        return getOnItemLongClickListener().onItemLongClick(TxBaseQuickAdapter.this, v, position);
    }
    ...
    protected K createBaseViewHolder(View view) {
        ...
        // 泛型擦除会导致z为null
        if (z == null) {
            k = (K) new TxBaseViewHolder(view);
        } else {
            k = createGenericKInstance(z, view);
        }
        return k != null ? k : (K) new TxBaseViewHolder(view);
    }
        ...
        if (type instanceof ParameterizedType) {
            ...
            for (Type temp : types) {
                if (temp instanceof Class) {
                    ...
                    if (TxBaseViewHolder.class.isAssignableFrom(tempClass)) {
                        return tempClass;
                    }
                } else if (temp instanceof ParameterizedType) {
                    Type rawType = ((ParameterizedType) temp).getRawType();
                    if (rawType instanceof Class && TxBaseViewHolder.class.isAssignableFrom((Class<?>) rawType)) {
     ...
     * then {@link TxBaseQuickAdapter#convert(com.chad.library.adapter.base.BaseViewHolder, Object)} will not execute, and will
    ...
    public View getViewByPosition(RecyclerView recyclerView, int position, @IdRes int viewId) {
        ...
        TxBaseViewHolder viewHolder = (TxBaseViewHolder) recyclerView.findViewHolderForLayoutPosition(position);
        if (viewHolder == null) {
            return null;
        }
...
//            subItemCount += list.size();
    ...
    public interface OnItemChildClickListener {
         ...
         */
        void onItemChildClick(TxBaseQuickAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemChildLongClickListener {
         ...
         */
        boolean onItemChildLongClick(TxBaseQuickAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         * @return true if the callback consumed the long click ,false otherwise
         */
        boolean onItemLongClick(TxBaseQuickAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(TxBaseQuickAdapter adapter, View view, int position);
    }
