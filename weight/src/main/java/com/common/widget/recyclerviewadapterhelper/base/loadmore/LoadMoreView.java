package com.common.widget.recyclerviewadapterhelper.base.loadmore;
...
public abstract class LoadMoreView {
    ...
    public void convert(TxBaseViewHolder holder) {
    ...
    private void visibleLoading(TxBaseViewHolder holder, boolean visible) {
        holder.setGone(getLoadingViewId(), visible);
    }

    private void visibleLoadFail(TxBaseViewHolder holder, boolean visible) {
        holder.setGone(getLoadFailViewId(), visible);
    }

    private void visibleLoadEnd(TxBaseViewHolder holder, boolean visible) {
