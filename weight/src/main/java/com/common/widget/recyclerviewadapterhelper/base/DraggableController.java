...
import com.common.widget.recyclerviewadapterhelper.base.listener.IDraggableListener;
import com.common.widget.recyclerviewadapterhelper.base.listener.OnItemDragListener;
import com.common.widget.recyclerviewadapterhelper.base.listener.OnItemSwipeListener;
...
public class DraggableController implements IDraggableListener {
    ...
    private TxBaseQuickAdapter mAdapter;

    public DraggableController(TxBaseQuickAdapter adapter) {
        mAdapter = adapter;
    }

    public void initView(TxBaseViewHolder holder) {
