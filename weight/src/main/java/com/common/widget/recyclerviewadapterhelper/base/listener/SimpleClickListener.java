...
import static com.common.widget.recyclerviewadapterhelper.base.TxBaseQuickAdapter.EMPTY_VIEW;
import static com.common.widget.recyclerviewadapterhelper.base.TxBaseQuickAdapter.FOOTER_VIEW;
import static com.common.widget.recyclerviewadapterhelper.base.TxBaseQuickAdapter.HEADER_VIEW;
import static com.common.widget.recyclerviewadapterhelper.base.TxBaseQuickAdapter.LOADING_VIEW;
...
public abstract class SimpleClickListener implements RecyclerView.OnItemTouchListener {
    ...
    protected TxBaseQuickAdapter baseQuickAdapter;
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        if (recyclerView == null) {
            ...
            this.baseQuickAdapter = (TxBaseQuickAdapter) recyclerView.getAdapter();
        ...
        if (!mGestureDetector.onTouchEvent(e) && e.getActionMasked() == MotionEvent.ACTION_UP && mIsShowPress) {
            if (mPressedView != null) {
                TxBaseViewHolder vh = (TxBaseViewHolder) recyclerView.getChildViewHolder(mPressedView);
    ...
    private class ItemTouchHelperGestureListener implements GestureDetector.OnGestureListener {
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            if (mIsPrepressed && mPressedView != null) {
                ...
                TxBaseViewHolder vh = (TxBaseViewHolder) recyclerView.getChildViewHolder(pressedView);
     ...
     */
    public abstract void onItemClick(TxBaseQuickAdapter adapter, View view, int position);
     ...
     */
    public abstract void onItemLongClick(TxBaseQuickAdapter adapter, View view, int position);
    /**
     ...
     * @return true if the callback consumed the long click ,false otherwise
     */
    public abstract void onItemChildClick(TxBaseQuickAdapter adapter, View view, int position);
    /**
     * callback method to be invoked when an item in this view has been
     * click and held
     * @param adapter
     ...
     * @return true if the callback consumed the long click ,false otherwise
     */
    public abstract void onItemChildLongClick(TxBaseQuickAdapter adapter, View view, int position);
    ...
    private boolean isHeaderOrFooterPosition(int position) {
        ...
        if (baseQuickAdapter == null) {
            if (recyclerView != null) {
                baseQuickAdapter = (TxBaseQuickAdapter) recyclerView.getAdapter();
            } else {
                return false;
            }
        }
