...
import com.common.widget.toast.config.IToast;
...
public class ToastStrategy extends Handler implements IToastStrategy {
    ...
    public IToast createToast(Application application) {
        ...
        //todo
        if (toast instanceof ActivityToast || Build.VERSION.SDK_INT < 30 ||
                application.getApplicationInfo().targetSdkVersion < 30) {
