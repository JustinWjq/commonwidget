 ...
 * @date 2017 /5/9
 */
public class TxBarParams implements Cloneable {
    /**
     * 状态栏颜色
     ...
     * The Bar hide.
     */
    public TxBarHide barHide = TxBarHide.FLAG_SHOW_BAR;
    /**
     * 状态栏字体深色与亮色标志位
     * The Dark font.
     */
    ...
    @Override
    protected TxBarParams clone() {
        TxBarParams barParams = null;
        try {
            barParams = (TxBarParams) super.clone();
