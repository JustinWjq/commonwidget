...
class RequestManagerRetriever implements Handler.Callback {
    ...
    private String mTag = TxImmersionBar.class.getName();
     ...
     */
    public TxImmersionBar get(Activity activity) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar get(Fragment fragment, boolean isOnly) {
    ...
    public TxImmersionBar get(android.app.Fragment fragment, boolean isOnly) {
        checkNotNull(fragment, "fragment is null");
        checkNotNull(fragment.getActivity(), "fragment.getActivity() is null");
