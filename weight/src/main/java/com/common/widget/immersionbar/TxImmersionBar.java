package com.common.widget.immersionbar;
...
import static com.common.widget.immersionbar.TxImmersionBarConstants.*;
...
public final class TxImmersionBar implements TxImmersionCallback {
    ...
    private TxImmersionBar mParentBar;
     ...
     * 用户配置的bar参数
     */
    private TxBarParams mBarParams;
    /**
     * 系统bar相关信息
     */
    private TxBarConfig mBarConfig;
    /**
     * 导航栏的高度，适配Emui3系统有用
     */
     ...
     * 用户使用tag增加的bar参数的集合
     */
    private Map<String, TxBarParams> mTagMap = new HashMap<>();
    /**
     ...
     */
    public static TxImmersionBar with(@NonNull Activity activity) {
     ...
     * @return the immersion bar
     */
    public static TxImmersionBar with(@NonNull Fragment fragment) {
     ...
     * @return the immersion bar
     */
    public static TxImmersionBar with(@NonNull Fragment fragment, boolean isOnly) {
     ...
     * @return the immersion bar
     */
    public static TxImmersionBar with(@NonNull android.app.Fragment fragment) {
        return getRetriever().get(fragment, false);
    }
     ...
     * @return the immersion bar
     */
    public static TxImmersionBar with(@NonNull android.app.Fragment fragment, boolean isOnly) {
        return getRetriever().get(fragment, isOnly);
    }
     ...
     * @return the immersion bar
     */
    public static TxImmersionBar with(@NonNull DialogFragment dialogFragment) {
     ...
     * @return the immersion bar
     */
    public static TxImmersionBar with(@NonNull android.app.DialogFragment dialogFragment) {
        return getRetriever().get(dialogFragment, false);
    }
     ...
     * @return the immersion bar
     */
    public static TxImmersionBar with(@NonNull Activity activity, @NonNull Dialog dialog) {
    ...
    void onDestroy() {
        ...
        if (mIsDialog && mParentBar != null) {
            ...
            if (mParentBar.mBarParams.barHide != TxBarHide.FLAG_SHOW_BAR) {
                mParentBar.setBar();
            }
        }
        mInitialized = false;
    ...
    void onResume() {
        if (!mIsFragment && mInitialized && mBarParams != null) {
            if (OSUtils.isEMUI3_x() && mBarParams.navigationBarWithEMUI3Enable) {
                ...
                if (mBarParams.barHide != TxBarHide.FLAG_SHOW_BAR) {
                    setBar();
                }
            }
        }
    ...
    private void updateBarConfig() {
        mBarConfig = new TxBarConfig(mActivity);
     ...
     */
    public TxBarParams getBarParams() {
        return mBarParams;
    }
    ...
    public static boolean hasNavigationBar(@NonNull Activity activity) {
        TxBarConfig config = new TxBarConfig(activity);
     ...
     * @param activity the activity
     */
    TxImmersionBar(Activity activity) {
        mIsActivity = true;
        mActivity = activity;
     ...
     * @param fragment the fragment
     */
    TxImmersionBar(Fragment fragment) {
        mIsFragment = true;
     ...
     * @param fragment the fragment
     */
    TxImmersionBar(android.app.Fragment fragment) {
        mIsFragment = true;
        mActivity = fragment.getActivity();
        mFragment = fragment;
        checkInitWithActivity();
     ...
     * @param dialogFragment the dialog fragment
     */
    TxImmersionBar(DialogFragment dialogFragment) {
        mIsDialog = true;
     ...
     * @param dialogFragment the dialog fragment
     */
    TxImmersionBar(android.app.DialogFragment dialogFragment) {
        mIsDialog = true;
        mIsDialogFragment = true;
        mActivity = dialogFragment.getActivity();
     ...
     * @param dialog   the dialog
     */
    TxImmersionBar(Activity activity, Dialog dialog) {
        mIsDialog = true;
        mActivity = activity;
        mDialog = dialog;
        checkInitWithActivity();
     ...
     * @return the immersion bar
     */
    public TxImmersionBar transparentStatusBar() {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar transparentNavigationBar() {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar transparentBar() {
        mBarParams.statusBarColor = Color.TRANSPARENT;
        mBarParams.navigationBarColor = Color.TRANSPARENT;
        mBarParams.fullScreen = true;
        return this;
     ...
     * @return the immersion bar
     */
    public TxImmersionBar statusBarColor(@ColorRes int statusBarColor) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar statusBarColor(String statusBarColor) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar statusBarColorInt(@ColorInt int statusBarColor) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar navigationBarColor(@ColorRes int navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar navigationBarColor(String navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar navigationBarColorInt(@ColorInt int navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar barColor(@ColorRes int barColor) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar barColor(@ColorRes int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar barColor(String barColor) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar barColor(String barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar barColorInt(@ColorInt int barColor) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar barColorInt(@ColorInt int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
        mBarParams.statusBarColor = barColor;
        mBarParams.navigationBarColor = barColor;
     ...
     * @return the immersion bar
     */
    public TxImmersionBar statusBarColorTransform(@ColorRes int statusBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar statusBarColorTransform(String statusBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar statusBarColorTransformInt(@ColorInt int statusBarColorTransform) {
        mBarParams.statusBarColorTransform = statusBarColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public TxImmersionBar navigationBarColorTransform(@ColorRes int navigationBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar navigationBarColorTransform(String navigationBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar navigationBarColorTransformInt(@ColorInt int navigationBarColorTransform) {
        mBarParams.navigationBarColorTransform = navigationBarColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public TxImmersionBar barColorTransform(@ColorRes int barColorTransform) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar barColorTransform(String barColorTransform) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar barColorTransformInt(@ColorInt int barColorTransform) {
        mBarParams.statusBarColorTransform = barColorTransform;
        mBarParams.navigationBarColorTransform = barColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public TxImmersionBar addViewSupportTransformColor(View view) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar addViewSupportTransformColor(View view, @ColorRes int viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar addViewSupportTransformColor(View view, @ColorRes int viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public TxImmersionBar addViewSupportTransformColor(View view, String viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar addViewSupportTransformColor(View view, String viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public TxImmersionBar addViewSupportTransformColorInt(View view, @ColorInt int viewColorAfterTransform) {
        if (view == null) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar addViewSupportTransformColorInt(View view, @ColorInt int viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public TxImmersionBar viewAlpha(@FloatRange(from = 0f, to = 1f) float viewAlpha) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar removeSupportView(View view) {
        if (view == null) {
            throw new IllegalArgumentException("View参数不能为空");
        }
     ...
     * @return the immersion bar
     */
    public TxImmersionBar removeSupportAllView() {
        if (mBarParams.viewMap.size() != 0) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar fullScreen(boolean isFullScreen) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar statusBarAlpha(@FloatRange(from = 0f, to = 1f) float statusAlpha) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar navigationBarAlpha(@FloatRange(from = 0f, to = 1f) float navigationAlpha) {
        mBarParams.navigationBarAlpha = navigationAlpha;
     ...
     * @return the immersion bar
     */
    public TxImmersionBar barAlpha(@FloatRange(from = 0f, to = 1f) float barAlpha) {
        mBarParams.statusBarAlpha = barAlpha;
     ...
     * @return the immersion bar
     */
    public TxImmersionBar autoDarkModeEnable(boolean isEnable) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar autoDarkModeEnable(boolean isEnable, @FloatRange(from = 0f, to = 1f) float autoDarkModeAlpha) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar autoStatusBarDarkModeEnable(boolean isEnable) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar autoStatusBarDarkModeEnable(boolean isEnable, @FloatRange(from = 0f, to = 1f) float autoDarkModeAlpha) {
        mBarParams.autoStatusBarDarkModeEnable = isEnable;
        mBarParams.autoStatusBarDarkModeAlpha = autoDarkModeAlpha;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public TxImmersionBar autoNavigationBarDarkModeEnable(boolean isEnable) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar autoNavigationBarDarkModeEnable(boolean isEnable, @FloatRange(from = 0f, to = 1f) float autoDarkModeAlpha) {
        mBarParams.autoNavigationBarDarkModeEnable = isEnable;
        mBarParams.autoNavigationBarDarkModeAlpha = autoDarkModeAlpha;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public TxImmersionBar statusBarDarkFont(boolean isDarkFont) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar statusBarDarkFont(boolean isDarkFont, @FloatRange(from = 0f, to = 1f) float statusAlpha) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar navigationBarDarkIcon(boolean isDarkIcon) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar navigationBarDarkIcon(boolean isDarkIcon, @FloatRange(from = 0f, to = 1f) float navigationAlpha) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar flymeOSStatusBarFontColor(@ColorRes int flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar flymeOSStatusBarFontColor(String flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar flymeOSStatusBarFontColorInt(@ColorInt int flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar hideBar(TxBarHide barHide) {
        mBarParams.barHide = barHide;
        if (Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT || OSUtils.isEMUI3_x()) {
            mBarParams.hideNavigationBar = (mBarParams.barHide == TxBarHide.FLAG_HIDE_NAVIGATION_BAR) ||
                    (mBarParams.barHide == TxBarHide.FLAG_HIDE_BAR);
        }
        return this;
    }
     ...
     * @return the immersion bar
     */
    public TxImmersionBar applySystemFits(boolean applySystemFits) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar fitsSystemWindows(boolean fits) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar fitsSystemWindows(boolean fits, @ColorRes int contentColor) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar fitsSystemWindowsInt(boolean fits, @ColorInt int contentColor) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar fitsLayoutOverlapEnable(boolean fitsLayoutOverlapEnable) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar statusBarView(View view) {
        if (view == null) {
            return this;
        }
     ...
     * @return the immersion bar
     */
    public TxImmersionBar statusBarView(@IdRes int viewId) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar statusBarView(@IdRes int viewId, View rootView) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar titleBar(View view) {
        if (view == null) {
            return this;
        }
     ...
     * @return the immersion bar
     */
    public TxImmersionBar titleBar(View view, boolean statusBarColorTransformEnable) {
        if (view == null) {
            return this;
        }
        if (mFitsStatusBarType == FLAG_FITS_DEFAULT) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar titleBar(@IdRes int viewId) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar titleBar(@IdRes int viewId, boolean statusBarColorTransformEnable) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar titleBar(@IdRes int viewId, View rootView) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar titleBar(@IdRes int viewId, View rootView, boolean statusBarColorTransformEnable) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar titleBarMarginTop(@IdRes int viewId) {
        if (mSupportFragment != null && mSupportFragment.getView() != null) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar titleBarMarginTop(@IdRes int viewId, View rootView) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar titleBarMarginTop(View view) {
        if (view == null) {
            return this;
        }
        if (mFitsStatusBarType == FLAG_FITS_DEFAULT) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar supportActionBar(boolean isSupportActionBar) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar statusBarColorTransformEnable(boolean statusBarColorTransformEnable) {
        mBarParams.statusBarColorEnabled = statusBarColorTransformEnable;
        return this;
    }
     ...
     * @return the bar tag
     */
    public TxImmersionBar addTag(String tag) {
        if (isEmpty(tag)) {
            throw new IllegalArgumentException("tag不能为空");
        }
        TxBarParams barParams = mBarParams.clone();
     ...
     * @return the immersion bar
     */
    public TxImmersionBar getTag(String tag) {
        if (isEmpty(tag)) {
            throw new IllegalArgumentException("tag不能为空");
        }
        TxBarParams barParams = mTagMap.get(tag);
        if (barParams != null) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar keyboardEnable(boolean enable) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar keyboardEnable(boolean enable, int keyboardMode) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar keyboardMode(int keyboardMode) {
        mBarParams.keyboardMode = keyboardMode;
        return this;
    }
     ...
     */
    public TxImmersionBar setOnKeyboardListener(@Nullable OnKeyboardListener onKeyboardListener) {
     ...
     */
    public TxImmersionBar setOnNavigationBarListener(OnNavigationBarListener onNavigationBarListener) {
     ...
     */
    public TxImmersionBar setOnBarListener(OnBarListener onBarListener) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar navigationBarEnable(boolean navigationBarEnable) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar navigationBarWithKitkatEnable(boolean navigationBarWithKitkatEnable) {
     ...
     * @return the immersion bar
     */
    public TxImmersionBar navigationBarWithEMUI3Enable(boolean navigationBarWithEMUI3Enable) {
        //是否可以修改emui3系列手机导航栏
     ...
     * @return the immersion bar
     */
    public TxImmersionBar barEnable(boolean barEnable) {
