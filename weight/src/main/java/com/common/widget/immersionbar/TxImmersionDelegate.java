 ...
 */
class TxImmersionDelegate implements Runnable {

    private TxImmersionBar mImmersionBar;
    private TxBarProperties mBarProperties;
    private OnBarListener mOnBarListener;
    private int mNotchHeight;

    TxImmersionDelegate(Object o) {
        if (o instanceof Activity) {
            if (mImmersionBar == null) {
                mImmersionBar = new TxImmersionBar((Activity) o);
            }
        } else if (o instanceof Fragment) {
            if (mImmersionBar == null) {
                if (o instanceof DialogFragment) {
                    mImmersionBar = new TxImmersionBar((DialogFragment) o);
                } else {
                    mImmersionBar = new TxImmersionBar((Fragment) o);
                }
            }
        } else if (o instanceof android.app.Fragment) {
            if (mImmersionBar == null) {
                if (o instanceof android.app.DialogFragment) {
                    mImmersionBar = new TxImmersionBar((android.app.DialogFragment) o);
                } else {
                    mImmersionBar = new TxImmersionBar((android.app.Fragment) o);
                }
            }
        }
    }

    TxImmersionDelegate(Activity activity, Dialog dialog) {
        if (mImmersionBar == null) {
            mImmersionBar = new TxImmersionBar(activity, dialog);
        }
    }

    public TxImmersionBar get() {
        ...
        if (mImmersionBar != null && mImmersionBar.initialized() && Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            if (mOnBarListener != null) {
                ...
                if (mBarProperties == null) {
                    mBarProperties = new TxBarProperties();
                }
    ...
    public void run() {
        if (mImmersionBar != null && mImmersionBar.getActivity() != null) {
            ...
            TxBarConfig barConfig = new TxBarConfig(activity);
